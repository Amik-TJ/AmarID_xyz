...
use App\Http\Controllers\AdminPanelUserRegisterController;
use App\Models\Card;
...
class VerifyUserImport implements ToModel,WithHeadingRow
{
    ...
    */
    ...
    {
        $static_account_type_id = AdminPanelUserRegisterController::$static_account_type;
        // name splitting
        ...
        if($sub_field_id == null)
        {
            ...
            $sub_field->fieldID = $static_account_type_id;
        ...
        if(!empty($phone))
        {
            ...
            if($all_phone->isEmpty() && $all_email->isEmpty())
            {
                ...
                $user->accTypeID = AdminPanelUserRegisterController::$static_account_type;
                ...
                $card->softID = '100';
                $card->expire_date = new DateTime("next year");;
                $card->save();
