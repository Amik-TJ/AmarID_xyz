...
@section('content')
    ...
    <div class="main-banner" id="top">
        <video autoplay muted loop id="bg-video">
            <source src="/css/career/career.mp4" type="video/mp4" />
        </video>

        <div class="video-overlay header-text">
            <div class="caption">
                <h6>Career at AmarID.xyz</h6>
                <h2>Join with <em class="text-danger">AmarID</em></h2>
    ...
    <section class="section" id="trainers">
        <div class="container">
            <div class="row">
                <div class="col-lg-6 offset-lg-3">
                    <div class="section-heading">
                        <h2>Career at  <em class="text-danger">AmarID.xyz</em></h2>
                        <img src="/images/career/line-dec.png" alt="">
                        <p>At AmarID we appreciate both Professionals and Fresh who aspire to grow and develop themselves with the organization. We also like them to be skillful and efficient which will benefit them to grow as a leader both inside and outside the organization and lead us to the brink of success in future.</p>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-4">
                    <div class="trainer-item bg-dark">
                        <div class="image-thumb">
                            <img src="/images/career/job_1.jpg" alt="">
                        </div>
                        <div class="down-content">
                            <span>$ Negotiable  </span>

                            <h4 class="text-white">Freelancer Laravel Developer</h4>

                            <p class="text-light">Intern &nbsp;/&nbsp; Part-Time</p>
                            <p class="text-light">Deadline &nbsp;:&nbsp; 1 Jan 2021</p>

                            <ul class="social-icons">
                                <li><a href=" " class="text-info">+ View More</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="trainer-item bg-dark">
                        <div class="image-thumb">
                            <img src="/images/career/job_2.jpg" alt="">
                        </div>
                        <div class="down-content">
                            <span>$ Negotiable  </span>

                            <h4 class="text-white">Freelancer Vue.js Developer</h4>
                ...
                <div class="col-lg-4">
                    <div class="trainer-item bg-dark">
                        <div class="image-thumb">
                            <img src="/images/career/job_3.jpg" alt="">
                        </div>
                        <div class="down-content">
                            <span>$ Negotiable  </span>

                            <h4 class="text-white">Senior Flutter Developer</h4>

                            <p class="text-light">Full Time</p>
                            <p class="text-light">Deadline &nbsp;:&nbsp; 1 Jan 2021</p>
            ...
            <div class="main-button text-center">
                <a href="jobs.html" class="bg-danger">View Jobs</a>
            </div>
        </div>
    </section>
    <!-- ***** Cars Ends ***** -->
...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/css/career/bootstrap.min.css">

    <link rel="stylesheet" type="text/css" href="/css/career/font-awesome.css">
        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="trainer-item">
                    <div class="image-thumb">
                        <img src="/images/career/product-1-720x480.jpg" alt="">
                    </div>
                    <div class="down-content">
            ...
            <div class="col-lg-4">
                <div class="trainer-item">
                    <div class="image-thumb">
                        <img src="/images/career/product-2-720x480.jpg" alt="">
                    </div>
                    <div class="down-content">
                        <span> <sup>$</sup>70 000 </span>
            ...
            <div class="col-lg-4">
                <div class="trainer-item">
                    <div class="image-thumb">
                        <img src="/images/career/product-3-720x480.jpg" alt="">
                    </div>
                    <div class="down-content">
                        <span> <sup>$</sup>70 000 </span>
        ...
        <div class="row" id="tabs">
            ...
            <div class="col-lg-8">
                <section class='tabs-content'>
                    <article id='tabs-1'>
                        <img src="/images/career/blog-image-1-940x460.jpg" alt="">
                    ...
                    <article id='tabs-2'>
                        <img src="/images/career/blog-image-2-940x460.jpg" alt="">
                    ...
                    <article id='tabs-3'>
                        <img src="/images/career/blog-image-3-940x460.jpg" alt="">
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <ul class="features-items">
                    <li class="feature-item">
                        <div class="left-icon">
                            <img src="/images/career/features-first-icon.png" alt="First One">
                        </div>
                    ...
                    <li class="feature-item">
                        <div class="left-icon">
                            <img src="/images/career/features-first-icon.png" alt="second one">
                        </div>
                        <div class="right-content">
                            <h4>John Doe</h4>
                            <p><em>"Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dicta numquam maxime voluptatibus, impedit sed! Necessitatibus repellendus sed deleniti id et!"</em></p>
            ...
            <div class="col-lg-6">
                <ul class="features-items">
                    <li class="feature-item">
                        <div class="left-icon">
                            <img src="/images/career/features-first-icon.png" alt="fourth muscle">
                        </div>
                        <div class="right-content">
                            <h4>John Doe</h4>
                            <p><em>"Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dicta numquam maxime voluptatibus, impedit sed! Necessitatibus repellendus sed deleniti id et!"</em></p>
                    ...
                    <li class="feature-item">
                        <div class="left-icon">
                            <img src="/images/career/features-first-icon.png" alt="training fifth">
                        </div>
                        <div class="right-content">
                            <h4>John Doe</h4>
                            <p><em>"Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dicta numquam maxime voluptatibus, impedit sed! Necessitatibus repellendus sed deleniti id et!"</em></p>
...
<!-- jQuery -->
<script src="/js/career/jquery-2.1.0.min.js"></script>

<!-- Bootstrap -->
--}}
{{--<script src="/js/career/popper.js"></script>
<script src="/js/career/bootstrap.min.js"></script>--}}{{--
