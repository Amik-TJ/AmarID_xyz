...
@section('content')
    ...
    <div class="jumbotron">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header text-center text-danger font-weight-bold">{{ __('Vendor Registration') }}</div>

                    <div class="card-body">
                        <form method="POST" action="/push_vendor_registration">
                            @csrf
                            ...
                            {{---------------------------------Role----------------------------}}
                            <div class="form-group row">
                                <label for="sub_field" class="col-md-4 col-form-label text-md-right">{{ __('Vendor Type') }}</label>

                                <div class="col-md-6">
                                    <select class="form-control" id="vendor_type" name="vendor_type">
                                        <option value="">---------</option>
                                        <option value="1">Print Vendor</option>
                                        <option value="2">Delivery Vendor</option>
                                    </select>
                                    @error('vendor_type')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
