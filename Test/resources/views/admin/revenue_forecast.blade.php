                               ...
                               <table class="table v-middle  table-hover" id="my_table">
                                   ...
                                   @foreach($data['data'] as $all)
                                       <tr>
                                           ...
                                           <td>
                                               <form action="/make_order_invoice" method="POST">
                                                   @csrf
                                                   <input type="hidden" name="order_id" value="{{$all->orderID}}">
                                                   <input type="hidden" name="user_id" value="{{$all->userID}}">
                                                   @if($all->hardCopyIncluded)
                                                       <button type="submit" class="btn-warning btn-sm">Print</button>
                                                   @else
                                                       <button class="btn-warning btn-sm" disabled="disabled">Print
                                                       </button>
                                                   @endif
                                               </form>
                                           </td>
