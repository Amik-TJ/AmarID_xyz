                                    ...
                                    <div class="col">
                                        <div class="card card-profile text-center">
                                            ...
                                            <p class="text-dark px-4 font-weight-bold">
                                                <h3 class="text-success">Delivery Vendor</h3>
                                            </p>
                                        </div>
                                    </div>
                                </div>
        ...
        <div class="row mb-5">
                ...
                <div class="card gradient-1 h-100">
                    <div class="card-body">
                        ...
                        <div class="d-inline-block">
                            <h2 class="text-white">{{$data['total_delivery_job']}}</h2>
                        </div>
            ...
            <div class="col-lg-3 col-sm-6 mb-1">
                <div class="card gradient-2 h-100">
                    <div class="card-body">
                        <h3 class="card-title text-white">On Delivery</h3>
                        <div class="d-inline-block">
                            <h2 class="text-white">{{$data['on_delivery']}}</h2>
                        </div>
            ...
            <div class="col-lg-3 col-sm-6 mb-1">
                <div class="card gradient-3 h-100">
                    <div class="card-body">
                        <h3 class="card-title text-white">Delivery Complete</h3>
                        <div class="d-inline-block">
                            <h2 class="text-white">{{$data['delivery_complete']}}</h2>
                        </div>
            ...
            <div class="col-lg-3 col-sm-6 mb-1">
                <div class="card gradient-4 h-100">
                    <div class="card-body">
                        <h3 class="card-title text-white">Acount Status</h3>
                        <div class="d-inline-block">
                            <h2 class="text-white">{{auth()->user()->active == 1 ? 'Active' : 'Deactivate'}}</h2>
                        </div>
