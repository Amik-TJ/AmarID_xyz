                                    ...
                                    <tr>
                                        <td>
                                            @if($all->photo_url != null)
                                                <img src="{{url('storage'.$all->photo_url)}}" class=" rounded-circle mr-3 ml-3 zoom" style="height: 40px; width: 40px">
                                            @else
                                                <img src="{{url('storage/uploads/3.jpg')}}" class=" rounded-circle mr-3 ml-3 zoom" style="height: 40px; width: 40px">
                                            @endif
