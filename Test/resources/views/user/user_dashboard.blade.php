                                        ...
                                        @foreach($data['latest_orders'] as $all)
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    @if($all->status == 'Print Vendor Assigned' || $all->status == 'Print Done' ||$all->status == 'Print Complete and Received' ||$all->status == 'Assign Delivery Vendor' || $all->status == 'Order Confirmed')
                                                        Processing
                                                    @else
                                                        {{$all->status}}
                                                    @endif
