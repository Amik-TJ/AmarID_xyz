    ...
    <div class="row mt-4">
        <div class="col-md-6 col-sm-12 mb-3">
            <div class="card h-100 w-100 d-inline-block"
                        ...
                        <div class="form-group">
                            <div class="d-flex">
                                <input type="text" class="form-control rounded-pill border-dark font-weight-bold"
                                       ...
                                       name="keyword" style="font-family:Comfortaa, FontAwesome" required>
                ...
                @php
                $fields = \App\Models\Field::where('iconUrl','!=','NULL')->where('search_field',1)->get()->take(16);
                $count = 0;
                $total = 16;
                    ...
                    @foreach($fields as $f)
                        ...
                        @endif
                            <div class="col text-center my-auto">
                                <a href="" onclick="search_function('<?php echo $f->fieldName ?>');return false;"><img src="{{url('storage/'.$f->iconUrl)}}" class="search_image img-fluid" alt=""><figcaption class="search_caption text-danger font-weight-bold">{{$f->fieldName}}</figcaption></a>
                            </div>
                                <?php $count++;?>
            ...
            <div class="card rounded h-75 w-100 d-inline-block"
                ...
                <div class="card-body">
                    <div class="card rounded-pill mt-2 mb-3">
                        ...
                        <div class="centered text-dark font-weight-bold" style="font-size: 12px;">
                    ...
                    <div class="card rounded-pill mb-auto">
                        ...
                        <div class="display-6 centered text-dark font-weight-bold my-auto" style="font-size: 12px">
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header text-center">
                        <h5 class="text-success text-center font-weight-bold my-2" style="text-align: center;">Search Results for : " <span class="text-danger font-weight-light">{{$data['keyword']}}</span> " </h5>
                    ...
                    <div class="modal-body">
                        ...
                        @if($data['found'] == true)
                            <p class="text-center font-weight-bold text-primary my-3">{{$data['search_count']}} Results Found</p>
                            <hr class="border-bottom shadow mb-2">
                            ...
                            <div class="col-12">
                                <div class="card border-white">
                                    ...
                                    <div class="card-footer text-center bg-white">
                                        <a href="{{url('storage/'.$card['qr_path'])}}" class="btn mb-1 btn-rounded btn-success" download><span class="btn-icon-left"><i class="fa fa-download color-warning"></i> </span>Download</a>
                                    </div>
                                </div>
                            </div>
