...
<!-- Facebook Pixel Code -->
    ...
    <noscript><img height="1" width="1" style="display:none" src="https://www.facebook.com/tr?id=252656616326418&ev=PageView&noscript=1"/></noscript>
...
@include('inc.admin.quixlab_admin_sidebar')
...
@yield('single_filename_bootstrap_js')
@yield('edit_js')
@yield('package_js')
@yield('extra_js')
@yield('excess_amount_verify')
</body>
</html>
