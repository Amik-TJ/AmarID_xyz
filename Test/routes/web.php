...
Route::POST('/make_order_invoice', '\App\Http\Controllers\RevenueForecastController@make_order_invoice')->middleware('admin');
//Route::GET('/download_order_invoice/{order_id}', '\App\Http\Controllers\RevenueForecastController@download_order_invoice')->middleware('admin');
...
// Card Details
Route::POST('/view_order_details', '\App\Http\Controllers\ViewOrderDetailsController@view_order_details')->middleware('admin_print');
...
Route::get('/test', '\App\Http\Controllers\SubFieldController@test');
